# Generated by Powerlevel10k configuration wizard on 2024-07-03 at 19:16 PDT.
...
() {
  function prompt_mise() {
    local plugins=("${(@f)$(mise ls --current 2>/dev/null | awk '!/\(symlink\)/ && $3!="~/.tool-versions" && $3!="~/.config/mise/config.toml" && $3!="~/dotfiles/mise/config.toml" {print $1, $2}')}")
    local plugin
